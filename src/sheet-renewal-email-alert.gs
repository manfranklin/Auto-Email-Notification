 ...
 * Date: 2023-09-27
 * Description: Sends renewal notifications to users from a Google Sheets file when the renewal date is within 45 days.
 */
  ...
  for (let retry = 0; retry < 2; retry++) {
    try {
      ...
      if (retry < 1) {
        ...
        console.log("Maximum retry attempts reached. Script execution failed.");
        break;
      }
    }
  }
